(custom-set-variables
 ...
 '(company-global-modes
   '(lisp-mode emacs-lisp-mode restclient-mode js-mode js2-mode js-jsx-mode js2-jsx-mode rjsx-mode python-mode go-mode rust-mode web-mode c-mode c++-mode objc-mode css-mode sh-mode typescript-mode ruby-mode enh-ruby-mode))
 ...
 '(package-selected-packages
   '(add-node-modules-path ag all-the-icons all-the-icons-dired amx apib-mode async auto-compile auto-yasnippet blacken browse-kill-ring buffer-move bug-hunter cargo cl-lib-highlight clang-format cmake-font-lock company-box company-emoji company-flx company-lsp company-quickhelp company-restclient company-shell company-statistics company-tern company-web crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dimmer dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single docker docker-compose-mode dockerfile-mode dotenv-mode dumb-jump editorconfig eglot elisp-def elisp-refs emmet-mode enh-ruby-mode eslintd-fix evil-numbers exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-golangci-lint flycheck-mypy flycheck-objc-clang flycheck-pos-tip flycheck-rust flycheck-yamllint focus fontify-face forge form-feed git-timemachine gitattributes-mode gitconfig-mode gitignore-mode go-eldoc go-mode goto-last-change graphql-mode graphviz-dot-mode helpful history hook-helpers hydra ialign ido-completing-read+ ido-vertical-mode imenu-anywhere imenu-list import-js importmagic jq-mode js-doc js-format js2-mode js2-refactor kurecolor lorem-ipsum lsp-mode lsp-ui macrostep magit magit-lfs magit-todos monky move-dup multi-term multiple-cursors nodejs-repl olivetti origami osx-trash package-build package-lint package-safe-delete package-utils pager-default-keybindings pcre2el pdf-tools po-mode poly-markdown poly-rst polymode prettier-js projectile projectile-rails protobuf-mode py-autopep8 py-isort pyimport python-docstring quelpa-use-package rainbow-mode reason-mode restart-emacs restclient rg rjsx-mode rust-mode sass-mode sbt-mode scala-mode scss-mode smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc string-inflection tern tide try ts-comint tuareg typescript-mode undo-propose use-package visual-regexp-steroids web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose xterm-color yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
