(custom-set-variables
 ...
 '(package-selected-packages
   '(add-node-modules-path ag aggressive-indent all-the-icons all-the-icons-dired amx apib-mode arduino-mode auto-compile auto-yasnippet beginend browse-kill-ring buffer-move bug-hunter buttercup cargo cask-mode company company-native-complete company-prescient company-quickhelp coverage crm-custom crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single direnv docker-compose-mode dotenv-mode editorconfig elisp-def elisp-refs emmet-mode enh-ruby-mode eterm-256color exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-cask flycheck-golangci-lint flycheck-inline flycheck-package flycheck-plantuml flycheck-projectile focus fontify-face forge gcmh git-commit git-modes git-timemachine go-mode graphql-mode graphviz-dot-mode groovy-mode helpful highlight-indent-guides hl-todo ialign ibuffer-projectile ido-completing-read+ ido-vertical-mode iedit imenu-anywhere imenu-list impostman jq-format jq-mode jsonian kurecolor lorem-ipsum lsp-docker lsp-java lsp-jedi lsp-metals lsp-mode lsp-origami lsp-pyright lsp-sourcekit lsp-ui macrostep magit magit-lfs magit-todos markdown-mode monky move-dup multiple-cursors native-complete nodejs-repl olivetti origami osx-trash package-build package-lint package-utils page-break-lines pcre2el pdf-tools pet plantuml-mode po-mode powerline prettier projectile projectile-rails protobuf-mode python-black python-docstring python-insert-docstring python-isort python-pytest quelpa-use-package quick-peek rainbow-mode reason-mode reformatter repeat-help request rg ron-mode sass-mode sbt-mode scala-mode scroll-on-jump shift-number shrink-path shut-up smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc spinner ssh-config-mode string-inflection svg-lib swift-mode terraform-mode ts-comint tuareg udev-mode use-package verb visual-regexp-steroids vterm vundo web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yard-mode yarn-mode yasnippet yasnippet-snippets))
 '(page-break-lines-lighter "")
 '(parens-require-spaces nil)
 '(prescient-persist-mode t)
 '(prettier-enabled-parsers
   '(angular babel babel-flow css flow graphql json json5 less html mdx scss typescript vue yaml))
