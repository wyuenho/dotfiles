(custom-set-variables
 ...
 '(package-selected-packages
   '(add-node-modules-path ag aggressive-indent all-the-icons all-the-icons-dired apib-mode arduino-mode auto-compile auto-yasnippet bazel beginend bind-key browse-kill-ring buffer-move bug-hunter buttercup cargo cask-mode company company-native-complete company-prescient company-quickhelp coverage crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single docker-compose-mode dotenv-mode editorconfig elisp-def elisp-refs embark emmet-mode enh-ruby-mode envrc eterm-256color exec-path-from-shell expand-region faceup flycheck flycheck-cask flycheck-deno flycheck-golangci-lint flycheck-inline flycheck-package flymake focus fontify-face forge gcmh git-commit git-modes git-timemachine go-mode graphql-mode graphviz-dot-mode groovy-mode helpful highlight-indent-guides hl-todo ialign ibuffer-projectile iedit imenu-anywhere imenu-list impostman inheritenv jq-mode jsdoc jsonian jsonrpc kurecolor lorem-ipsum lsp-java lsp-jedi lsp-metals lsp-mode lsp-origami lsp-pyright lsp-sourcekit lsp-ui macrostep magit magit-lfs magit-todos marginalia markdown-mode monky move-dup multiple-cursors native-complete nodejs-repl olivetti origami package-build package-lint page-break-lines pager-default-keybindings pcre2el pdf-tools pet plantuml-mode po-mode powerline prettier projectile projectile-rails protobuf-mode python-black python-docstring python-insert-docstring python-isort python-pytest quelpa quelpa-use-package quick-peek rainbow-mode reason-mode reformatter repeat-help request rg ron-mode sass-mode sbt-mode scala-mode scroll-on-jump shift-number shrink-path shut-up smart-semicolon smartparens smooth-scrolling soap-client solarized-theme spaceline sphinx-doc spinner ssh-config-mode string-inflection svg-lib swift-mode terraform-mode tide ts-comint tuareg udev-mode verb verilog-mode vertico vertico-prescient visual-regexp-steroids vterm vundo web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
