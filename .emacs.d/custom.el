(custom-set-variables
 ...
 '(package-selected-packages
   '(abridge-diff add-node-modules-path ag all-the-icons all-the-icons-dired amx apib-mode async auto-compile auto-yasnippet beginend bind-key browse-kill-ring buffer-move bug-hunter cargo cl-lib-highlight clang-format cmake-font-lock company company-box company-native-complete company-prescient company-restclient company-web crm-custom crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single docker docker-compose-mode dockerfile-mode dotenv-mode dumb-jump editorconfig eldoc-box elisp-def elisp-refs emmet-mode emojify enh-ruby-mode eterm-256color exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-golangci-lint flycheck-objc-clang flycheck-posframe flycheck-pyre flycheck-rust flycheck-yamllint focus fontify-face forge form-feed git-timemachine gitattributes-mode gitconfig-mode gitignore-mode go-eldoc go-mode goto-last-change graphql-mode graphviz-dot-mode helpful hl-todo ialign icomplete-vertical ido-completing-read+ ido-vertical-mode iedit imenu-anywhere imenu-list import-js importmagic jq-mode js-doc js2-mode json-mode kurecolor lorem-ipsum lsp-jedi lsp-mode lsp-origami lsp-sourcekit macrostep magit magit-lfs magit-todos mb-url monky move-dup multiple-cursors native-complete nodejs-repl olivetti orderless origami osx-trash package-build package-lint package-safe-delete package-utils pager-default-keybindings paradox pcre2el pdf-tools po-mode poetry prettier projectile projectile-rails protobuf-mode py-isort pyimport python-black python-docstring quelpa-use-package rainbow-mode reason-mode reformatter restart-emacs restclient rg rjsx-mode rust-mode sass-mode sbt-mode scala-mode scss-mode shift-number shrink-path smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc string-inflection swift-mode tree-sitter tree-sitter-langs ts-comint tuareg typescript-mode undo-fu unicode-fonts visual-regexp-steroids vterm web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
