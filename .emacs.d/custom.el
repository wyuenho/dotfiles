(custom-set-variables
 ...
 '(package-selected-packages
   '(abridge-diff add-node-modules-path ag aggressive-indent all-the-icons all-the-icons-dired amx apib-mode auto-compile auto-yasnippet beginend browse-kill-ring buffer-move bug-hunter cargo cl-lib-highlight cmake-font-lock company company-box company-native-complete company-prescient crm-custom crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single direnv docker docker-compose-mode dockerfile-mode dotenv-mode dumb-jump editorconfig elisp-def elisp-refs emacsql-sqlite emmet-mode emojify enh-ruby-mode envrc eterm-256color exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-golangci-lint flycheck-package flycheck-posframe focus fontify-face forge form-feed git-timemachine gitattributes-mode gitconfig-mode gitignore-mode go-mode graphql-mode graphviz-dot-mode helpful highlight-indent-guides hl-todo ialign ido-completing-read+ ido-vertical-mode iedit imenu-anywhere imenu-list import-js importmagic jq-mode js-doc js2-mode json-mode kurecolor lorem-ipsum lsp-jedi lsp-metals lsp-mode lsp-origami lsp-pyright lsp-sourcekit lsp-ui macrostep magit magit-lfs magit-libgit magit-todos monky move-dup multiple-cursors native-complete nodejs-repl olivetti origami osx-trash package-build package-lint package-safe-delete package-utils pager-default-keybindings paradox pcre2el pdf-tools po-mode powerline prettier projectile projectile-rails protobuf-mode python-black python-docstring python-isort quelpa-use-package rainbow-mode reason-mode reformatter request restart-emacs rg rjsx-mode rust-mode sass-mode sbt-mode scala-mode scss-mode shift-number shrink-path shut-up smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc spinner string-inflection swift-mode tree-sitter tree-sitter-langs ts-comint tuareg typescript-mode undo-fu unicode-fonts verb visual-regexp-steroids vterm web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
