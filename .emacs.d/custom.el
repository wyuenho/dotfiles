(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smooth-scrolling ido-vertical-mode ido-ubiquitous company-flx flx-ido flx-isearch smex typescript-mode golden-ratio cycle-quotes eyebrowse kill-or-bury-alive centered-window-mode pcre2el origami esup docker which-key package-lint package-build git-timemachine syntax-subword use-package mocha-snippets react-snippets editorconfig markdown-mode magit magit-filenotify magit-gh-pulls magit-gitflow magithub move-dup projectile try tide spaceline-all-the-icons spaceline vlf gitattributes-mode gitconfig-mode gitignore-mode company-quickhelp expand-region rainbow-mode exec-path-from-shell less-css-mode whitespace-cleanup-mode anaconda-mode company string-inflection eslintd-fix py-autopep8 all-the-icons-dired pyimport pyenv-mode-auto python python-docstring company-dict company-shell zoom-frm yasnippet yaml-mode web-mode undo-tree sphinx-doc solarized-theme smartparens scss-mode py-isort nose monky js-doc graphviz-dot-mode flycheck-mypy evil-numbers emmet-mode dumb-jump dockerfile-mode csv-mode company-web company-tern company-anaconda auto-compile ag)))
