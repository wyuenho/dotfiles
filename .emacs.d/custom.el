(custom-set-variables
 ...
 '(connection-local-criteria-alist
   '(((:application eshell)
     ...
     ((:application tramp :machine "MobileCat.localdomain")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp)
 ...
 '(package-selected-packages
   '(abridge-diff add-node-modules-path ag aggressive-indent all-the-icons all-the-icons-dired amx apib-mode arduino-mode auto-compile auto-yasnippet beginend browse-kill-ring buffer-move bug-hunter buttercup cargo cask-mode cmake-font-lock cmake-mode company company-native-complete company-prescient company-quickhelp coverage crm-custom crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single direnv docker-compose-mode dotenv-mode dumb-jump editorconfig elisp-def elisp-refs emmet-mode enh-ruby-mode eterm-256color exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-cask flycheck-golangci-lint flycheck-inline flycheck-package flycheck-plantuml flycheck-projectile focus fontify-face forge git-commit git-modes git-timemachine graphql-mode graphviz-dot-mode groovy-mode helpful highlight-indent-guides hl-todo ialign ibuffer-vc ido-completing-read+ ido-vertical-mode iedit imenu-anywhere imenu-list import-js impostman jq-format jq-mode js-doc jsonian kurecolor lorem-ipsum lsp-docker lsp-java lsp-jedi lsp-mode lsp-origami lsp-pyright lsp-sourcekit lsp-ui macrostep magit magit-lfs magit-todos markdown-mode monky move-dup multiple-cursors native-complete nodejs-repl olivetti origami osx-trash package-build package-lint package-utils page-break-lines pager-default-keybindings paradox pcre2el pdf-tools pet plantuml-mode po-mode powerline prettier projectile projectile-rails protobuf-mode python-black python-docstring python-insert-docstring python-isort python-pytest quelpa-use-package quick-peek rainbow-mode reason-mode repeat-help request restart-emacs rg ron-mode sass-mode sbt-mode scala-mode scroll-on-jump shift-number shrink-path shut-up smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc spinner ssh-config-mode string-inflection svg-lib swift-mode terraform-mode ts-comint tuareg udev-mode use-package verb visual-regexp-steroids vterm vundo web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
 ...
 '(rainbow-html-colors-major-mode-list
   '(html-mode php-mode nxml-mode xml-mode web-mode rjsx-mode mhtml-mode js-ts-mode js-jsx-mode tsx-ts-mode))
 ...
 '(so-long-target-modes '(css-mode css-ts-mode js-mode js-ts-mode js-jsx-mode))
 '(solarized-use-variable-pitch nil)
 '(sp-hybrid-kill-excessive-whitespace t)
 '(sp-ignore-modes-list '(minibuffer-mode minibuffer-inactive-mode vterm-mode))
 '(sp-navigate-consider-sgml-tags
   '(html-mode web-mode rjsx-mode js2-jsx-mode js-jsx-mode nxml-mode js-ts-mode tsx-ts-mode))
