(custom-set-variables
 ...
 '(package-selected-packages
   '(add-node-modules-path ag all-the-icons all-the-icons-dired amx anaconda-mode apib-mode async auto-compile auto-yasnippet beginend browse-kill-ring buffer-move bug-hunter cargo cl-lib-highlight clang-format cmake-font-lock company-anaconda company-box company-emoji company-flx company-lsp company-native-complete company-quickhelp company-restclient company-statistics company-tern company-terraform company-web crm-custom crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dimmer dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single docker docker-compose-mode dockerfile-mode dotenv-mode dumb-jump editorconfig eglot elisp-def elisp-refs emmet-mode enh-ruby-mode eterm-256color exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-golangci-lint flycheck-objc-clang flycheck-pos-tip flycheck-pyre flycheck-rust flycheck-yamllint focus fontify-face forge form-feed git-timemachine gitattributes-mode gitconfig-mode gitignore-mode go-eldoc go-mode goto-last-change graphql-mode graphviz-dot-mode helpful history hydra ialign icomplete-vertical ido-completing-read+ ido-vertical-mode imenu-anywhere imenu-list import-js importmagic jq-mode js-doc js2-mode kurecolor lorem-ipsum lsp-mode lsp-origami lsp-python-ms macrostep magit magit-lfs magit-todos monky move-dup multiple-cursors nodejs-repl olivetti origami osx-trash package-build package-lint package-safe-delete package-utils pager-default-keybindings pcre2el pdf-tools po-mode poly-markdown poly-rst polymode prettier projectile projectile-rails protobuf-mode py-autopep8 py-isort pyimport python-black python-docstring quelpa quelpa-use-package rainbow-mode reason-mode reformatter restart-emacs restclient rg rjsx-mode rust-mode sass-mode sbt-mode scala-mode scss-mode shift-number smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc string-inflection tern terraform-doc terraform-mode tide try ts-comint tuareg typescript-mode undo-fu use-package visual-regexp-steroids vterm web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
