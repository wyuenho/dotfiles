(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ag all-the-icons all-the-icons-dired anaconda-mode ascii auto-compile bind-key centered-window-mode company company-anaconda company-flx company-go company-quickhelp company-restclient company-shell company-statistics company-tern company-web csv-mode cycle-quotes diminish docker dockerfile-mode dumb-jump editorconfig emmet-mode eslintd-fix esup evil-numbers exec-path-from-shell expand-region eyebrowse flx-ido flx-isearch flycheck flycheck-demjsonlint flycheck-yamllint focus git-timemachine gitattributes-mode gitconfig-mode gitignore-mode go-eldoc go-mode go-projectile golden-ratio graphviz-dot-mode ido-completing-read+ ido-vertical-mode idomenu importmagic js-comint js-doc js2-refactor json-mode kill-or-bury-alive kurecolor less-css-mode lorem-ipsum macrostep magit magit-filenotify magit-gh-pulls magit-gitflow magithub markdown-mode mocha-snippets monky move-dup multi-term multiple-cursors nose nvm origami package-build package-lint pcre2el pdf-tools popwin projectile py-autopep8 py-isort pyenv-mode pyimport python python-docstring rainbow-mode react-snippets restclient rjsx-mode scss-mode smartparens smex smooth-scrolling solarized-theme sphinx-doc string-inflection sudo-edit syntax-subword tide try ts-comint undo-tree use-package visual-regexp visual-regexp-steroids web-mode web-mode-edit-element which-key whitespace-cleanup-mode xref-js2 yaml-mode yarn-mode zoom-frm)))
 '(pyenv-mode t)
