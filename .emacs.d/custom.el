(custom-set-variables
 ...
 '(completion-styles '(flex basic partial-completion substring initials))
 ...
 '(package-selected-packages
   '(add-node-modules-path ag all-the-icons all-the-icons-dired amx apib-mode auto-compile auto-yasnippet beginend bind-key browse-kill-ring buffer-move bug-hunter cargo cl-lib-highlight clang-format cmake-font-lock company company-box company-emoji company-native-complete company-quickhelp company-restclient company-web crm-custom crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dimmer dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single docker docker-compose-mode dockerfile-mode dotenv-mode dumb-jump editorconfig elisp-def elisp-refs emmet-mode enh-ruby-mode eterm-256color exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-golangci-lint flycheck-objc-clang flycheck-pos-tip flycheck-pyre flycheck-rust flycheck-yamllint focus fontify-face forge form-feed git-timemachine gitattributes-mode gitconfig-mode gitignore-mode go-eldoc go-mode goto-last-change graphql-mode graphviz-dot-mode helpful hydra ialign icomplete-vertical ido-completing-read+ ido-vertical-mode iedit imenu-anywhere imenu-list import-js importmagic jq-mode js-doc js2-mode json-mode kurecolor lorem-ipsum lsp-jedi lsp-mode lsp-origami lsp-sourcekit macrostep magit magit-delta magit-lfs magit-todos monky move-dup multiple-cursors native-complete nodejs-repl olivetti orderless origami osx-trash package-build package-lint package-safe-delete package-utils pager-default-keybindings pcre2el pdf-tools po-mode poetry poly-markdown poly-rst polymode prettier projectile projectile-rails protobuf-mode py-autopep8 py-isort pyimport python-black python-docstring quelpa quelpa-use-package quelpa-use-package rainbow-mode reason-mode reformatter restart-emacs restclient rg rjsx-mode rust-mode sass-mode sbt-mode scala-mode scss-mode shift-number smart-semicolon smartparens smooth-scrolling so-long solarized-theme spaceline sphinx-doc string-inflection swift-mode tree-sitter tree-sitter-langs ts-comint tuareg typescript-mode undo-fu unicode-fonts use-package visual-regexp-steroids vterm web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
