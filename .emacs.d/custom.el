(custom-set-variables
 ...
 '(aggressive-indent-excluded-modes
   '(elm-mode haskell-mode inf-ruby-mode makefile-mode makefile-gmake-mode python-mode sql-interactive-mode text-mode yaml-mode tcl-mode dockerfile-mode go-mode jsonian-mode web-mode))
 '(amx-mode t)
 ...
 '(package-selected-packages
   '(abridge-diff add-node-modules-path ag aggressive-indent all-the-icons all-the-icons-dired amx apib-mode arduino-mode async-await auto-compile auto-yasnippet beginend browse-kill-ring buffer-move bug-hunter buttercup cargo cask-mode cmake-font-lock cmake-mode company company-box company-native-complete company-prescient coverage crm-custom crux csv-mode cycle-quotes dap-mode default-text-scale delight diff-hl dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single direnv docker-compose-mode dockerfile-mode dotenv-mode dumb-jump editorconfig elisp-def elisp-refs emmet-mode enh-ruby-mode eterm-256color exec-path-from-shell expand-region fancy-compilation flx-ido flx-isearch flycheck flycheck-cask flycheck-golangci-lint flycheck-inline flycheck-package flycheck-projectile focus fontify-face forge form-feed git-commit git-modes git-timemachine go-mode graphql-mode graphviz-dot-mode helpful highlight-indent-guides hl-todo ialign ibuffer-vc ido-completing-read+ ido-vertical-mode iedit imenu-anywhere imenu-list import-js jq-format jq-mode js-doc js2-mode jsonian kurecolor lorem-ipsum lsp-docker lsp-java lsp-jedi lsp-metals lsp-mode lsp-origami lsp-pyright lsp-sourcekit lsp-ui macrostep magit magit-lfs magit-libgit magit-todos markdown-mode monky move-dup multiple-cursors native-complete nodejs-repl olivetti origami osx-trash package-build package-lint package-utils pager-default-keybindings paradox pcre2el pdf-tools po-mode powerline prettier projectile projectile-rails promise protobuf-mode python-black python-docstring python-insert-docstring python-isort python-pytest quelpa-use-package quick-peek rainbow-mode reason-mode reformatter repeat-help request restart-emacs rg rjsx-mode ron-mode rust-mode sass-mode sbt-mode scala-mode scroll-on-jump scss-mode shift-number shrink-path shut-up smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc spinner ssh-config-mode string-inflection svg-lib swift-mode tide tree-sitter tree-sitter-langs ts-comint tuareg typescript-mode udev-mode use-package verb visual-regexp-steroids vterm vundo web-mode wgrep-ag which-key whitespace-cleanup-mode window-purpose yaml-mode yard-mode yarn-mode yasnippet yasnippet-snippets))
