(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (add-node-modules-path ag all-the-icons all-the-icons-dired amx apib-mode async auto-compile auto-yasnippet blacken browse-kill-ring buffer-move bug-hunter cargo cl-lib-highlight clang-format cmake-font-lock company-emoji company-flx company-go company-lsp company-quickhelp company-restclient company-shell company-statistics company-tern company-web crux csv-mode cycle-quotes default-text-scale delight diff-hl dimmer dired-collapse dired-hacks-utils dired-hide-dotfiles dired-single docker dockerfile-mode dotenv-mode dumb-jump editorconfig eglot elisp-def elisp-refs emmet-mode eslintd-fix evil-numbers exec-path-from-shell expand-region flx-ido flx-isearch flycheck flycheck-clang-analyzer flycheck-golangci-lint flycheck-mypy flycheck-objc-clang flycheck-pos-tip flycheck-rust flycheck-yamllint focus fontify-face forge form-feed git-timemachine gitattributes-mode gitconfig-mode gitignore-mode go-eldoc go-mode go-projectile god-mode goto-chg graphviz-dot-mode helpful hook-helpers ialign ido-completing-read+ ido-vertical-mode imenu-anywhere import-js importmagic indium jq-mode js-doc js-format js2-mode js2-refactor kurecolor lorem-ipsum lsp-go lsp-javascript-flow lsp-ocaml lsp-ui macrostep magit magit-todos monky move-dup multi-term multiple-cursors nodejs-repl nvm olivetti origami osx-trash package-build package-lint pager-default-keybindings pcre2el pdf-tools prettier-js projectile py-autopep8 py-isort pyimport python-docstring quelpa-use-package racer rainbow-mode reason-mode restart-emacs restclient rg rjsx-mode rust-mode scss-mode smart-semicolon smartparens smooth-scrolling solarized-theme spaceline sphinx-doc string-inflection tern tide try ts-comint tuareg typescript-mode undo-tree use-package visual-regexp-steroids web-mode wgrep-ag which-key whitespace-cleanup-mode xterm-color yaml-mode yarn-mode yasnippet)))
