                           ...
                           (last
                            (file-expand-wildcards
                             (concat
                              dap-utils-extension-path
                              "/golang.go-*"))))))
                (setq dap-go-debug-path go-debugger-path)
                           ...
                           (last
                            (file-expand-wildcards
                             (concat
                              dap-utils-extension-path
                              "/ms-vscode.cpptools-*"))))))
                (setq dap-cpptools-debug-path cpptools-debugger-path)
