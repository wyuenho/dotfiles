...
(use-package solarized-theme
  ...
  (dolist (face-map '((smerge-base                 . magit-diff-base)
                      ...
                      (ediff-even-diff-A           . magit-diff-context)
                      (ediff-even-diff-Ancestor    . magit-diff-context-highlight)
                      (ediff-even-diff-B           . magit-diff-context)
                      (ediff-even-diff-C           . magit-diff-context)
                      (ediff-odd-diff-A            . magit-diff-context)
                      (ediff-odd-diff-Ancestor     . magit-diff-context-highlight)
                      (ediff-odd-diff-B            . magit-diff-context)
                      (ediff-odd-diff-C            . magit-diff-context)
    ...
    (let* ((face (car face-map))
           (alias (cdr face-map))
           (alias-theme-face (cadr (car (get alias 'theme-face)))))
      (put face 'theme-face nil)
      (face-spec-set face (or alias-theme-face
                              (get alias 'face-defface-spec)
